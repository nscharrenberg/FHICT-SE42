...
--
-- Host: 127.0.0.1
-- Generation Time: May 28, 2018 at 11:21 AM
...
INSERT INTO `items` (`ID`, `DTYPE`, `DESCRIPTION`, `cat_description`, `SELLER_ID`) VALUES
(1, 'Furniture', 'broodkast', 'cat2', 1),
(2, 'Painting', 'omsch1', 'cat2', 1),
(3, 'items', 'The science of Discworld', 'boek', 1);
...
--
ALTER TABLE `furniture`
  ADD CONSTRAINT `FK_FURNITURE_ID` FOREIGN KEY (`ID`) REFERENCES `items` (`ID`);
...
--
ALTER TABLE `painting`
  ADD CONSTRAINT `FK_PAINTING_ID` FOREIGN KEY (`ID`) REFERENCES `items` (`ID`);
COMMIT;
